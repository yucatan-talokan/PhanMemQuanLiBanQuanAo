...
public class LichSuGiaoDichJpanel extends javax.swing.JPanel {
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        for (HoaDon hd : hoaDonService.getAll()) {
            if (hd.getMaHoaDon().contains(txtSearch.getText())
                    || hd.getNhanVien().getTenNhanVien().contains(txtSearch.getText())
                    || hd.getKhachHang().getTen().contains(txtSearch.getText())
                    || hd.getSdt().contains(txtSearch.getText())) {
                list.add(hd);
            }
        }
        loadLichSu(list);
